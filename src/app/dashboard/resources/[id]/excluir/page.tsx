...
import { ExcluirResources } from '../../../../../components/resources/excluir-resources';
...
export default async function ResourcesExcluir({
  params,
}: {
  ...
  return <ExcluirResources result={result} idResources={id} />;
}
