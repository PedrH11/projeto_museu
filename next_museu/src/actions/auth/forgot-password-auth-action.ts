...
import { ForgotPasswordResponse } from '../../schemas/forgot-passward-schema';
import { AuthService } from '../../service/connection/AuthService';
import { ApiResponse } from '../../type/api';

export async function forgotPasswordAction(
  prevState: ApiResponse<ForgotPasswordResponse>,
  payload: {
    email: string;
    url: string;
  },
  ...
  try {
    ...
    return {
      ...
      timestamp: new Date().toISOString(),
      isNetworkError: true,
    } as ApiResponse<ForgotPasswordResponse> & { isNetworkError: boolean };
  }
}
