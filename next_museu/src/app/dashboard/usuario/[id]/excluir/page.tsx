...
import { ExcluirUsuario } from '../../../../../components/usuario/excluir-usuario';
...
export default async function UsuarioExcluir({
  params,
}: {
  ...
  return <ExcluirUsuario result={result} idUsuario={id} />;
}
